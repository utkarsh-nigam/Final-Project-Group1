...
#os.chdir("C:\Users\nsree_000\Desktop\DataMiningFinal-Project-Group\Code")
...
class LogisticRegressionClassifier(QMainWindow):
    ...
    def update(self):
        ...
        #specify random forest classifier
        self.clf_rf = LogisticRegression()
...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        MLModel3Button.setStatusTip('ML algorithm with LR ')
        ...
        MLModel4Button.setStatusTip('ML algorithm with KNN ')
